...
{
    public class PostingService : IPostingInvoiceService
    {
            ...
            ref string _Message)
        {
            ...
            CasheringUtils.UpdateBalance(_RsvID, FolioID, pt, ref _Message);

            // ActionPosting.InsertHistory(
            //     pt,
            //     _SysDate,
            //     _BusinessDate,
            //     mFD_Group.FolioID,
            //     mFD_Group.FolioID,
            //     mFD_Group.InvoiceNo,
            //     ActionPosting.HistoryType.Gen_Post,
            //     ActionPosting.GetActionText(
            //         ActionPosting.HistoryType.Gen_Post,
            //         mFD_Group.TransactionCode,
            //         mFD_Group.Description),
            //     userName,
            //     mFD_Group.TransactionCode,
            //     mFD_Group.Description,
            //     mFD_Group.Amount,
            //     mFD_Group.Supplement,
            //     "", "", ""
            // );
        ...
        #region  Xử lý trực tiếp cho Services Invoice gọi ra contro
        /// <summary>
        /// Hàm service/webform thay thế logic btnPostInvoice_Click
        /// Không phụ thuộc WinForms control
        /// </summary>
        public ApiResponse PostInvoiceFromRequest(PostingInvoiceRequestDto request)
        {
